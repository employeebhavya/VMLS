document.addEventListener("DOMContentLoaded", function () {
  ...
  let headerPath = isRoot ? "./header.html" : "../header.html";
  ...
  fetch(headerPath)
    .then((response) => {
      ...
      if (!response.ok) {
        ...
        let altPath = isRoot ? "header.html" : "./header.html";
        console.log("Trying alternative header path:", altPath);
    ...
    .then((data) => {
      ...
      let headerElement = document.getElementById("vmls-header");
      ...
      if (headerElement) {
        ...
        headerElement.querySelectorAll("a").forEach((link) => {
        ...
        console.warn("Element with ID 'vmls-header' not found in the document");
      }
    })
    .catch((error) => {
      ...
      console.error(
        "Attempted paths:",
        headerPath,
        isRoot ? "header.html" : "./header.html"
      );
    });
});
